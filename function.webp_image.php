...
function smarty_function_webp_image($params, &$smarty)
{
  ...
  if(file_exists($path)) {
      ...
      $destination = 'tmp/cache/img-'.md5_file($path).'.webp';

      # If file alredy exists, return and stop
      if (file_exists($destination)) { return $destination; exit(); }
...
function smarty_cms_help_function_webp_image() {
   ...
   <p>HTML: &lt;img src="{webp_image src="uploads/simplex/images/cmsmadesimple-logo.png" quality="85"}" width="227" height="59"/&gt;
   <?php
} // End Function
/**
 * About text
